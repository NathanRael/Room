...
export default function WatchLists() {
  ...
  return (
    <>
      ...
      <div className="bg-secondary container-fluid p-0ps-sm-128 ps-lg-156 pe-sm-32">
        ...
        <div className="row d-flex flex-column row-gap-32 justify-content-center   pt-256 pb-128 py-md-128">
          {watchedList.length > 0 ? (
            animeWatchListItem
          ) : (
            <p className="_lead  text-primary text-center me-md-128">
